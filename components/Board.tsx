...
const Board = () => {
  ...
  // Helper functions for column drag and drop
  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div
        className="flex h-full w-full gap-2 md:gap-3 overflow-x-auto p-4 md:p-8 lg:p-12"
        ...
        {columns.map((column, index) => (
          <React.Fragment key={column.column}>
            ...
            <InteractiveColumn
              ...
              onDeleteList={handleDeleteList} // Pass down delete list function
            />
          </React.Fragment>
        ))}
